...
This document lists all custom ESLint rules used in Aurora to enforce product quality, brand consistency, and prevent common mistakes.
...
- Template colors that shouldn't be in Aurora
...
'product-quality/consistent-company-info': ['error', {
  companyName: 'Aurora',
  email: 'support@aurora.dev',
}]
```

**Detects:**
- Wrong company name: "VoiceCraft", "aurora", "LOGOSMITH"
- Wrong email: "info@...", "hello@...", etc.

**Example Violation:**
```tsx
<a href="mailto:info@aurora.com">  // ❌ Wrong email
  Contact Us
</a>
```
...
**Correct Usage:**
```tsx
<a href="mailto:support@aurora.dev">  // ✅ Correct email
  Contact Us
</a>
```
...
**Correct Usage:**
```tsx
<p>Choose from 7 Logo Design Styles</p>  // ✅ Aurora content
```
...
**Correct Usage:**
```tsx
<img src="/logo.png" alt="Aurora logo" />  // ✅ Has alt text

<Image
  src="/logo.png"
  alt="Aurora logo"  // ✅ Has alt text
  width={200}
  height={200}
/>
```
...
export default function Terms() {
  return (
    <div>
      ...
      <p>By accessing and using Aurora...</p>
      {/* ... real terms content ... */}
    </div>
  )
}
...
Copy `eslint.config.product.mjs` from Aurora to your project.
...
**Tested On:** Aurora (Next.js 16, TypeScript)
