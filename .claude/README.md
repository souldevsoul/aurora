# Aurora - Claude Code Documentation Index
...
**Purpose:** Align pages/components to Aurora design system
...
2. ✅ `consistent-company-info` - Enforces "Aurora" and "support@aurora.dev"
...
**For:** Aurora (AI-powered web application builder)
