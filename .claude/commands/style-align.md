...
You are helping a developer align a page or component to Aurora's design system. This is for cases where the functionality works, but the visual style doesn't match the brand.
...
Fix visual/style inconsistencies to match Aurora's design system.
...
## Step 2: Aurora Design System Reference
...
**Checklist:**
- [ ] Colors match Aurora palette (emerald/blue)
...
### After (Aurora style - soft, emerald/blue)
```tsx
...
1. **Commit with clear message**: `git commit -m "Align [PageName] to Aurora design system"`
