...
**Tested on:** Aurora (SaaS, Next.js, AI Integration)
...
**Required files (copy from Aurora or create):**
...
1. **`.claude/commands/onboard.md`**
   - Change project name (Aurora → YourProject)
...
**This boilerplate is battle-tested on Aurora.**
