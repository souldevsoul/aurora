# Aurora - Complete Project Setup Checklist
...
**Project:** Aurora (AI-powered MVP Development Platform)
**Status:** ⏳ In Progress
...
- [ ] Shows brand colors (Purple/Violet, NOT yellow)
...
**Location:** `/Users/rentamac/Documents/repos/repos/batch-2/aurora/.claude/commands/onboard.md`
...
**Purpose:** Align pages to Aurora design system

**Requirements:**
- [ ] References Aurora colors (Purple/Violet)
...
**Location:** `/Users/rentamac/Documents/repos/repos/batch-2/aurora/.claude/PRODUCT_SPEC.md`
...
**Key Sections:**
1. Brand Colors (Purple/Violet family)
...
5. `require-brand-in-header` - Logo must say "Aurora"
...
1. **use-styleguide-colors-only** ✅
   - Detects: Any non-brand colors (emerald/teal required for Aurora)
...
5. **consistent-company-info** ✅
   ...
   - Enforces: "Aurora" and "support@aurora.dev"
...
**Colors:**
- [ ] Only uses purple-*, violet-*, fuchsia-*, pink-*, slate-*
- [ ] NO yellow-*, orange-*, green-* (except utility) (except rare utility cases)
...
- [ ] Brand name: "Aurora" (not template)

---

**This checklist is the source of truth for Aurora project setup.**
