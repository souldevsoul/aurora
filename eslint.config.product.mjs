 ...
 * - purple/violet/pink/fuchsia color palette (creative and innovative theme)
 * - Company name: Aurora (Title Case)
 * - Email: support@auroradev.com (single contact point)
    ...
    rules: {
      ...
      'product-quality/use-styleguide-colors-only': ['error', {
        allowedColors: [
          ...
          // Aurora brand (purple/violet/pink/fuchsia)
      ...
      'product-quality/no-template-content': ['error', {
        ...
        forbiddenWords: [
          ...
          'Nimbus', 'Velocity', 'Accelerator', 'VoiceCraft', 'LogoSmith', 'Zenith',
