...
const Button = forwardRef<HTMLButtonElement, ButtonProps>(({
  ...
  const variantClasses = {
    ...
    secondary: 'text-gray-700 bg-white border border-gray-200 hover:bg-gray-50 hover:border-purple-600 focus:ring-purple-500 shadow-sm hover:shadow-none rounded-lg',
    outline: 'text-purple-700 bg-transparent border border-purple-600 hover:bg-purple-50 focus:ring-purple-500 rounded-lg',
