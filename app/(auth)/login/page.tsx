            ...
            <div className="max-w-md p-8 mb-8 mx-auto bg-white/40 backdrop-blur-md border border-white/30 rounded-3xl shadow-xl">
              ...
              <form onSubmit={handleEmailAuth} noValidate>
                ...
                {!isSignUp && (
                  <div className="text-right mb-8">
                    <a
                      className="inline-block text-sm font-semibold text-purple-600 hover:text-purple-700 focus:outline-none focus:underline"
                      href="#"
                    >
                      Forgot Password?
                    </a>
              ...
              {isSignUp && (
                <p className="mt-6 text-xs text-center text-gray-700">
                  ...
                  <Link href="/terms" className="text-purple-600 hover:text-purple-700 hover:underline font-medium">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-purple-600 hover:text-purple-700 hover:underline font-medium">
                    Privacy Policy
                  </Link>
                </p>
              )}
