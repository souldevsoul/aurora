...
export default function LegalPage() {
  const seoData = {
    description: 'Legal information and policies for Aurora - Terms, Privacy, and Compliance.',
            ...
            {[
              {
                ...
                description: 'Our terms and conditions for using the Aurora platform.',
                link: '/terms'
              },
              {
                icon: Shield,
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-purple-600 to-violet-700 rounded-2xl flex items-center justify-center mb-6 group-hover:scale-110 transition-transform">
