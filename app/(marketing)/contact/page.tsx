...
export default function ContactPage() {
  const seoData = {
    description: 'Get in touch with the Aurora team. We\'re here to help with any questions about our platform.',
    keywords: ['contact', 'support', 'help', 'sales', 'customer service']
  }

  return (
    <PageContainer
      title="Contact Us - Aurora"
      seo={seoData}
    >
      {/* Hero */}
        ...
        <div className="container px-4 mx-auto max-w-6xl">
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8 mb-16">
            {[
              ...
              >
                <div className="w-16 h-16 bg-gradient-to-br from-purple-600 to-violet-500 rounded-2xl flex items-center justify-center mx-auto mb-6 group-hover:scale-110 transition-transform">
