      ...
      <section className="pt-32 pb-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="space-y-20 mb-20">
            ...
            {/* Step 2 */}
            <div className="grid md:grid-cols-2 gap-12 items-center">
              <div className="order-2 md:order-1 bg-gradient-to-br from-purple-50 to-violet-50 rounded-2xl p-8 h-80 flex items-center justify-center">
                <Zap className="w-32 h-32 text-purple-600" />
              </div>
              <div className="order-1 md:order-2">
                <div className="flex items-center mb-6">
                  <div className="w-12 h-12 bg-gradient-to-br from-purple-600 to-violet-600 rounded-xl flex items-center justify-center text-white font-bold text-xl mr-4">
                    2
                  </div>
                  <h2 className="text-3xl font-bold text-gray-900">
                ...
                <ul className="space-y-3">
                  <li className="flex items-start">
                    <GitPullRequest className="w-5 h-5 text-purple-600 mr-3 mt-1" />
          ...
          <div className="text-center">
            ...
            <p className="text-xl text-gray-600 mb-8">
              Start shipping faster with Aurora
            </p>
