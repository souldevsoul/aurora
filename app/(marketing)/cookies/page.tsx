          ...
          <div className="prose prose-lg max-w-none">
            ...
            <section className="mb-12">
              ...
              <div className="bg-gray-100 rounded-lg p-6 mb-4">
                <button type="button" className="bg-gradient-to-br from-purple-600 to-violet-700 text-white px-6 py-3 rounded-lg font-semibold hover:opacity-90 transition">
