...
export default function PricingPage() {
  const seoData = {
    description: 'Simple, transparent pricing for Aurora. Pay only for what you use with our credit-based system.',
      ...
      <section className="relative bg-body">
        ...
        <div className="container px-4 mx-auto py-20 md:py-32">
          <div className="max-w-4xl mx-auto text-center">
            ...
            <div className="bg-purple-50 border border-purple-200 rounded-xl p-6 max-w-2xl mx-auto mb-12">
              ...
              <div key={index} className="relative">
                {pkg.popular && (
                  <div className="absolute -top-4 left-1/2 transform -translate-x-1/2 z-10">
                    <div className="inline-flex items-center gap-2 px-4 py-2 bg-gradient-to-br from-purple-600 to-violet-700 rounded-full shadow-lg">
                      <Sparkles className="w-4 h-4 text-white" />
                      <span className="text-white uppercase text-xs font-semibold">RECOMMENDED</span>
                    </div>
                  </div>
                )}
                <div className={`rounded-2xl border ${pkg.popular ? 'border-purple-600 shadow-2xl scale-105' : 'border-gray-200 shadow-lg'} bg-white/40 backdrop-blur-md border-white/30 p-8 h-full flex flex-col`}>
                    ...
                    <ul className="space-y-3">
                      {pkg.features.map((feature, idx) => (
                        <li key={idx} className="flex items-start">
                          <Check className="w-5 h-5 mr-3 flex-shrink-0 mt-0.5 text-violet-600" />
        ...
        <div className="container px-4 mx-auto max-w-6xl">
          ...
          <div className="grid md:grid-cols-2 gap-8 mb-12">
            ...
            <div className="bg-white/40 backdrop-blur-md rounded-3xl border border-white/30 p-8 shadow-lg">
              <div className="w-12 h-12 bg-gradient-to-br from-purple-600 to-violet-500 rounded-lg flex items-center justify-center mb-6">
