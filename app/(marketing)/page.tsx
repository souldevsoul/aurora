...
export default function HomePage() {
  const seoData = {
    description: 'Aurora is an AI-powered development platform that helps you build and deploy production-ready applications in hours, not months.',
    keywords: ['MVP development', 'AI code generation', 'rapid prototyping', 'developer platform', 'startup tools', 'web development', 'no-code']
  };

  return (
    <PageContainer
      title="Aurora - Build Production-Ready Apps Faster"
      seo={seoData}
    >
        ...
        <div className="container px-4 mx-auto relative z-10">
          <div className="max-w-7xl mx-auto text-center">
            ...
            <h1 className="font-heading tracking-tighter text-6xl sm:text-7xl lg:text-8xl font-black mb-8 leading-tight pt-16">
              ...
              <span className="block bg-gradient-to-r from-purple-600 via-violet-700 to-purple-800 bg-clip-text text-transparent">
        ...
        <div className="container mx-auto px-4">
          <div className="relative bg-white/40 backdrop-blur-md rounded-3xl p-12 border border-white/30">
            ...
            <div className="text-center group">
              <div className="text-5xl md:text-6xl font-black text-gray-900 mb-3 group-hover:text-purple-700 transition-colors">
                10hrs
              </div>
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-7xl mx-auto bg-white/40 backdrop-blur-md rounded-3xl p-12 border border-white/30">
            <div className="text-center mb-20">
              <p className="text-purple-600 font-bold text-sm uppercase tracking-wider mb-4">Features</p>
              <h2 className="text-5xl md:text-6xl font-black text-gray-900 mb-6">
                Everything you need <span className="text-purple-600">to ship faster</span>
              </h2>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              {[
                ...
                <div key={idx} className="group p-8 bg-white/5 backdrop-blur-md rounded-2xl border border-white/10 hover:border-pink-400/50 hover:bg-white/10 transition-all duration-300">
        ...
        <div className="container mx-auto px-4">
          <div className="max-w-5xl mx-auto text-center bg-white/40 backdrop-blur-md rounded-3xl p-16 border border-white/30">
            <h2 className="text-5xl md:text-7xl font-black text-gray-900 mb-6">
              Ready to build your <span className="text-purple-600">next project?</span>
            </h2>
