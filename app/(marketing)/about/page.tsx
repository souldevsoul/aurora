...
export default function AboutPage() {
  const seoData = {
    description: 'Learn about Aurora - the AI-powered platform that helps developers build MVPs and ship features faster.',
    keywords: ['about', 'company', 'mission', 'team', 'AI development', 'MVP builder']
  }

  return (
    <PageContainer
      title="About Us - Aurora"
      seo={seoData}
    >
      {/* Hero */}
          ...
          <div className="grid md:grid-cols-2 gap-16 items-center">
            <div className="bg-white/40 backdrop-blur-md rounded-3xl border border-white/30 p-8">
              ...
              <div className="space-y-6 text-lg text-gray-700 leading-relaxed">
                <p>
                  Aurora helps developers ship faster by automating repetitive development tasks. Built by experienced developers who understand the pain of rebuilding authentication, databases, and deployment pipelines for every project.
                </p>
                <p>
                  We've been there - setting up the same boilerplate code, configuring the same tools, solving the same problems over and over. That's why we built Aurora.
                </p>
                <p>
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            {[
              ...
              <div key={index} className="text-center bg-white/40 backdrop-blur-md rounded-3xl border border-white/30 p-6">
                <div className="w-16 h-16 bg-gradient-to-br from-purple-600 to-violet-500 rounded-2xl flex items-center justify-center mx-auto mb-6">
          ...
          <div className="grid md:grid-cols-2 gap-12">
            {[
              ...
              <div key={index} className="text-center bg-white/40 backdrop-blur-md rounded-3xl border border-white/30 p-8">
                <div className="text-5xl md:text-6xl font-bold bg-gradient-to-br from-purple-600 to-violet-500 bg-clip-text text-transparent mb-4">
                  {stat.number}
                </div>
      ...
      <section className="bg-white py-24">
        <div className="container mx-auto px-4">
          <div className="max-w-4xl mx-auto bg-gradient-to-br from-purple-600 to-violet-700 rounded-3xl p-12 md:p-16 text-center">
            ...
            <p className="text-xl text-white text-opacity-90 mb-10 max-w-2xl mx-auto">
              Be part of the future of software development. Start building with Aurora today.
            </p>
            <Link href="/login">
              <Button
                variant="secondary"
